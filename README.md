...
## Problem Statement:
Providing great customer service and understanding their pain points is the aim of every organization. There has been some scope for improvement in the real-time service provided across all MI outlets to its customers to process the custom orders efficiently.
...
* Lack of a recommendation system for the executive to get the best products that align with the customer purchase which will help him/her increase sales.
...
* It will allow the customer to share the pre-build cart with the store which can help save time and energy for both parties.
* The store will be able to look at the records through a database to initiate the warranty and 30-day return policy easily making the whole process smooth and efficient.
...
* **Flutter** to build the application that supports most of the platform.
...
* **Firebase Cloud Database and Real-time Database** to store and manage the data which is uploaded, and processed in relational databases.
* **Firebase** for user verification and authentication with Google Sign-In.

## Installation Guide: ⬇️
There are two ways by which this app can be installed and used. ( Currently supports Android and iOS).
#### Method 1 (Works only on Android):
* Clone the repository in your local system.
* Go to the Android Apps folder and transfer the app.apk file to your android device.
* Click on the file on your android device. 
* It might ask for some permissions, allow them.
* Click on Install. Google Play might warn you but you can avoid it. This happens because the app is not registered with Google Play.
* Enjoy the app!

#### Method 2:
* Clone the repository into your local system.
* Install Flutter using the link: https://docs.flutter.dev/get-started/install
* Connect your android device to the laptop.
* Go to developer settings in your android phone and allow USB Debugging.
* Open your command prompt and type "flutter run --no-sound-null-safety --no-multidex"
* Wait for the app to install on your device.
* Enjoy the app!

## App Demo Video Link: https://youtu.be/852bPBBbFrs
...
## Methodology Explanation Video Link: https://youtu.be/lBKfrUrDeFY
...
* It will bring security to the system which is important to build confidence and trust for both the customer and the operator.
* This efficient system backed with AI will help ease the process and give the best experience to the consumer without the condition of having a knowledgeable and empathetic operator.
* Finally, with this overall system the consumer would feel belong and become a part of the community to help get the best marketing done for the services and products offered by the organization.

## Future Scope:
If this application is adopted in MI stores I believe :
* It can help increase speed, and ease the whole workflow to give the best experience and satisfaction to the customer.
* If integrated with blockchain it can help in more secure storage of data in the database, hence bringing more trust and security into the system.
...
* It will help increase the conversion rate and enhance sales at every outlet and give the same best experience to the customer.
