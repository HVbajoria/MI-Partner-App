...
import 'package:mi_partner_app/utils.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildInvoiceInfo(InvoiceInfo info) {
    final paymentTerms = '${info.dueDate
        .difference(info.date)
        .inDays} days';
    final titles = <String>[
      'Invoice Number:',
      'Invoice Date:',
  ...
  static Widget buildFooter(Invoice invoice) =>
      Column(
        ...
        children: [
          ...
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(title: 'Payment Mode', value: invoice.supplier.paymentInfo),
        ],
      );
